...
namespace AllInOne
{
    public class StormBehavior : BehaviourStateBase
    {
        ...
        private readonly IKillThemAllModeService _defendFlagModeService;
        
        public StormBehavior(StateMachine stateMachine, byte stateId, EnemyController enemyController) : base(stateMachine, stateId, enemyController)
        {
            ...
            _defendFlagModeService = ServiceLocator.Instance.GetService<IKillThemAllModeService>();
        }
        ...
        public override void Enter()
        {
            ...
            enemyController.NavMeshAgent.SetDestination(_defendFlagModeService.MapCentre);
