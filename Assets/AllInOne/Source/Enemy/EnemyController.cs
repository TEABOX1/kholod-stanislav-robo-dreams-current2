...
namespace AllInOne
{
    public class EnemyController : MonoBehaviour
    {
        ...
        public EnemyHitScanGun HitScanGun => _hitScanGun;
        ...
        protected virtual void InitBehaviourTree()
        {
            ...
            BehaviourLeaf meeleAttackLeaf = new BehaviourLeaf((byte)EnemyBehaviour.Attack);
            BehaviourLeaf rangedAttackLeaf = new BehaviourLeaf((byte)EnemyBehaviour.Shoot);
        ...
        protected bool CheckRangeCondition()
        {
            return _playerdar.InMeeleRange;
        }
...
//            _behaviourMachine.AddState((byte)EnemyBehaviour.Search,
//                new SearchBehaviour(_behaviourMachine, (byte)EnemyBehaviour.Search, this));
//            _behaviourMachine.AddState((byte)EnemyBehaviour.Approach,
//                new ApproachBehaviour(_behaviourMachine, (byte)EnemyBehaviour.Approach, this));
...
//            BehaviourLeaf meleeAttackLeaf = new BehaviourLeaf((byte)EnemyBehaviour.Attack);
//            BehaviourLeaf approachLeaf = new BehaviourLeaf((byte)EnemyBehaviour.Approach);
//            BehaviourLeaf rangedAttackLeaf = new BehaviourLeaf((byte)EnemyBehaviour.Shoot);

//            BehaviourBranch attackBranch = new BehaviourBranch(meleeAttackLeaf, approachLeaf, InAttackRangeCondition);
//            BehaviourBranch approachBranch = new BehaviourBranch(attackBranch, rangedAttackLeaf, InApproachRangeCondition);
//            BehaviourBranch shootBranch = new BehaviourBranch(approachBranch, patrolBranch, InShootRangeCondition);

//            BehaviourBranch seesTarget = new BehaviourBranch(shootBranch, patrolBranch, SeesTargetCondition);
//            BehaviourBranch hasTarget = new BehaviourBranch(seesTarget, patrolBranch, HasTargetCondition);
...
//        protected bool InAttackRangeCondition()
//        {
//            return _playerdar.InMeeleRange;
//        }

//        protected bool InApproachRangeCondition()
//        {
//            return _playerdar.InMiddleRange;
//        }
//        protected bool InShootRangeCondition()
//        {
//            Debug.Log("InAttackRangeCondition");
//            return _playerdar.InRange;
//        }
